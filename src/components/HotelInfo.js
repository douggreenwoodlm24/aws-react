...
import HotelInfoDataServices from "../data/HotelInfo-Services.json";
import HotelInfoDataAccessibility from "../data/HotelInfo-Accessibility.json";
      ...
      <div className="scene" id="hotelinfo">
        ...
        <article id="usefulinfo">
          ...
          <section className="checklist" id="services">
            ...
            <ul>
              <ul>
                {HotelInfoDataServices.map((item, i) => (
          ...
          <section className="checklist" id="accessibility">
            ...
            <ul>
              {HotelInfoDataAccessibility.map((item, i) => (
                <li key={i}>{item.text}</li>
              ))}
            </ul>
          </section>
